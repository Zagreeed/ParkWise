...
<script>
        ...
        document.addEventListener("DOMContentLoaded", () => {
          ...
          const vehicleTypeData = {
            Car: <?= $content["vehicleCount"]["car_count"]?>,
            Motorcycle: <?= $content["vehicleCount"]["motorcycle_count"]?>,
            Truck: <?= $content["vehicleCount"]["truck_count"]?>,
          };
          ...
          if (donutCanvas && typeof Chart !== 'undefined') {
            async function loadParkingDonutChart() {
              try {
                const availableCount =<?= $content["slotAvailability"]["available_count"]?>;
                const occupiedCount = <?= $content["slotAvailability"]["occupied_count"]?>;
                const reservedCount = <?= $content["slotAvailability"]["reserved_count"]?>;
                ...
                new Chart(ctx, {
                  ...
                  data: {
                    ...
                    datasets: [{
                      ...
                      backgroundColor: [ "#30bf7f", "#ff4b4b", "#ff9f40"],
                      borderWidth: 0,
                      cutout: "60%"
                    }]
                  },
